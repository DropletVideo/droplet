!function() {
    ...
    var n, t = {
            ...
            function c(n) {
                ...
                function(n) {
                    ...
                    if (null != e) {
                        var r, o, i = [], u = !0, a = !1;
                        try {
                            for (e = e.call(n); !(u = (r = e.next()).done) && (i.push(r.value),
                            !t || i.length !== t); u = !0)
                                ;
                        } catch (n) {
                            a = !0,
                    ...
                    if (n) {
                        ...
                        "Map" === e || "Set" === e ? Array.from(n) : "Arguments" === e || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(e) ? a(n, t) : void 0
                    }
                }(t, e) || function() {
        ...
        1397: function(n, t, e) {
            ...
            function i(n, t) {
                var e = o()(n, {});
                return "" !== e.origin && "null" !== e.origin && e.origin || (e = o()(t + "/" + n.replace(/^\//g, ""), {})),
                e.toString()
            }
        },
        447: function(n, t, e) {
            ...
            function c() {
                return (c = u(regeneratorRuntime.mark((function n(t, e, o, i) {
                    var u, a, c;
            ...
            function f() {
                return (f = u(regeneratorRuntime.mark((function n(t, e, o, i, u, a) {
                    var c, l;
                    return regeneratorRuntime.wrap((function(n) {
                        for (; ; )
                            switch (n.prev = n.next) {
                            case 0:
                                ...
                                return n.next = 6,
                                (0,
                                r.post)(t, e, o || null).then(c).catch(l || null);
                            case 6:
                                n.next = 9;
                                break;
                            case 8:
            ...
            function p() {
                return (p = u(regeneratorRuntime.mark((function n(t, e, o, i, u, a) {
                    var c, l;
                    return regeneratorRuntime.wrap((function(n) {
                        for (; ; )
                            switch (n.prev = n.next) {
                            case 0:
                                ...
                                return n.next = 6,
                                (0,
                                r.put)(t, e, o || null).then(c).catch(l || null);
                            case 6:
                                n.next = 9;
                                break;
                            case 8:
            ...
            function d() {
                return (d = u(regeneratorRuntime.mark((function n(t, e, r, i, u) {
                    var a, c;
                    return regeneratorRuntime.wrap((function(n) {
                        for (; ; )
                            switch (n.prev = n.next) {
                            case 0:
                                ...
                                return n.next = 6,
                                o().delete(t, e || null).then(a).catch(c || null);
                            case 6:
                                n.next = 9;
                                break;
                            case 8:
